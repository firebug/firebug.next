...
const { marshal, demarshal } = require("dev/ports");
const { fromTarget } = require("dev/debuggee");
...
// Weak mapping between iframe's and their owner
// `Panel` instances.
...
//    "remote": true,
  ...
  // xxxHonza: pass also the toolbox
  ...
  panel.setup({ debuggee: debuggee, frame: frame, toolbox: toolbox });
