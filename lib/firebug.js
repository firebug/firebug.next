...
Locale.registerStringBundle("chrome://firebug.next/locale/firebug.properties");
Locale.registerStringBundle("chrome://firebug.next/locale/style-editor.properties");
Locale.registerStringBundle("chrome://firebug.next/locale/debugger.properties");
Locale.registerStringBundle("chrome://firebug.next/locale/performance-timing.properties");
Locale.registerStringBundle("chrome://firebug.next/locale/console.properties");
Locale.registerStringBundle("chrome://firebug.next/locale/dom.properties");
Locale.registerStringBundle("chrome://firebug.next/locale/network.properties");

const { Chrome } = require("./chrome/chrome.js");

// All top level modules should be required here.
require("./chrome/windowWatcher.js");
require("./chrome/startButton.js");
