...
const { PerformanceOverlay } = require("./performance/performance-overlay.js");
const { MemoryOverlay } = require("./memory/memory-overlay.js");
...
/** @lends Firebug */
{
  ...
  initialize: function(options) {
    ...
    ToolboxChrome.registerPanelOverlay(PerformanceOverlay);
    ToolboxChrome.registerPanelOverlay(MemoryOverlay);
