...
/** lends JSONViewerModel */
{
    ...
    initTabBody: makeInfallible(function({netInfoBody, file})
    {
        ...
        file.getResponseContent().then(content => {
          ...
          if (!file.jsonObject)
          {
              if (this.isJSON(content.mimeType, content.text)) {
    ...
    updateTabBody: makeInfallible(function({netInfoBody, file})
    {
        ...
        var tabBody = netInfoBody.querySelector(".netInfoJSONText");
    ...
    {
        var jsonString = new String(file.content.text);
...
JSONViewerModel.Preview = domplate(
{
    ...
    render: function(body, file)
    {
        ...
        var parentNode = this.bodyTag.append(input, body, this);
