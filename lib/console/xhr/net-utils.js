...
var NetUtils =
{
     ...
     * 1) Use file-extension to guess the mime type. This is preferred since
    ...
    getFileCategory: function(file)
    {
      ...
      var mimeType = this.getMimeType(file.content.mimeType, file.href);
    ...
    openResponseInTab: function(file) {
      file.getLongString(file.content.text).then(value => {
        let inputStream = Http.getInputStreamFromString(value);
        ...
        let dataUri = "data:" + file.content.mimeType + ";base64," +
          encodedResponse;
    ...
    openImageInTab: function(file) {
      file.getLongString(file.content.text).then(value => {
        Win.openNewTab("data:" + file.content.mimeType + ";base64," + value);
      });
    },
