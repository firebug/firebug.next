...
/** @lends LoggerActor */
{
   ...
   */
  destroy: function() {
    Trace.sysout("loggerActor.destroy; state: " + this.state +
    ...
    if (mm) {
      mm.removeMessageListener("http-monitor:examine-headers", this.onExamineHeaders);
   ...
   */
  disconnect: function() {
    Trace.sysout("loggerActor.disconnect; state: " + this.state +
      ", " + this.actorID, arguments);
  ...
  detach: method(expectState("attached", function() {
    Trace.sysout("loggerActor.detach; " + this.actorID, arguments);
    ...
    if (mm) {
      ...
      removeMessageListener("http-monitor:examine-headers", this.onExamineHeaders);
  ...
  onExamineHeaders: function(event) {
    Trace.sysout("!!! loggerActor.onExamineHeaders; " + this.actorID +
      ", from: " + event.data.monitorId, event);
  ...
  onExamineResponse: makeInfallible(function(event) {
    ...
    let originalWinId = WindowUtils.getOuterId(this.parent._originalWindow);
