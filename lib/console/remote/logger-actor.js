...
/*
 This file is loaded on the back-end (no module global defined)
 module.metadata = {
...
/** @lends LoggerActor */
{
  ...
  initialize: function(conn, parent) {
    ...
    Trace.sysout("loggerActor.initialize; end");
  },
  ...
  sendMessage: function(msg, tab) {
    ...
    let packet = {
      ...
      message: {
        category: "server",
        innerID: getInnerId(tabUtils.getTabContentWindow(tab)),
        level: msg.type,
