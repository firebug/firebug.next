...
/** @lends LoggerActor */
{
  ...
  onExamineResponse: function(event) {
    ...
    if (tab.linkedBrowser != linkedBrowser) {
      FBTrace.sysout("loggerActor.onExamineResponse; different tab " +
  ...
  sendMessage: function(msg, tab) {
    ...
    Trace.sysout("loggerActor.sendMessage; formatted:", formatted);

    // xxxHonza: do we need this chrome logger prop?
