...
/** @lends LoggerFront */
{
  ...
  onPacket: function(packet) {
    ...
    // Front.prototype.onPacket expects only response packets.
    // Since log packets are sent on events, by the client initiative
    // we don't forward them to the super class.
    if (ConsoleAPIMethods.indexOf(type) === -1)
