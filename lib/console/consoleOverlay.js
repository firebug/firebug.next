...
/** @lends ConsoleOverlay */
{
  ...
  applyTheme: function(win, oldTheme) {
    ...
    loadSheet(win, "chrome://firebug.next/skin/variables-view.css", "author");
  },
  ...
  unapplyTheme: function(win, newTheme) {
    ...
    removeSheet(win, "chrome://firebug.next/skin/variables-view.css", "author");
  },
  ...
  onApplyTheme: function(iframeWin, oldTheme) {
    ...
    loadSheet(iframeWin, "chrome://firebug.next/skin/webconsole.css", "author");
    loadSheet(iframeWin, "chrome://firebug.next/skin/domTree.css", "author");
    loadSheet(iframeWin, "chrome://firebug.next/skin/html.css", "author");
    loadSheet(iframeWin, "chrome://firebug.next/skin/performance-timing.css", "author");
  ...
  onUnapplyTheme: function(iframeWin, newTheme) {
    ...
    removeSheet(iframeWin, "chrome://firebug.next/skin/webconsole.css", "author");
    removeSheet(iframeWin, "chrome://firebug.next/skin/domTree.css", "author");
    removeSheet(iframeWin, "chrome://firebug.next/skin/html.css", "author");
    removeSheet(iframeWin, "chrome://firebug.next/skin/performance-timing.css", "author");
