...
/** @lends ConsoleOverlay */
  ...
  initialize: function(options) {
    ...
    panel.hud.jsterm.on("variablesview-open", this.onVariablesViewOpen);
    panel.hud.jsterm.on("variablesview-fetched", this.onVariablesViewFetched);
  },
  ...
  onVariablesViewOpen: function(eventId, view, options) {
    ...
    let container = view.document.querySelector("#variables");

    // TODO: customize output of the view
  },
