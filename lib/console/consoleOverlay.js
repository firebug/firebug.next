...
/** @lends ConsoleOverlay */
{
  ...
  initialize: function(options) {
    ...
    this.onMessagesAdded = this.onMessagesAdded.bind(this);
  ...
  onReady: function(options) {
    ...
    hud.ui.on("messages-added", this.onMessagesAdded);
    hud.ui.on("messages-updated", this.onMessagesUpdated);
  ...
  destroy: function() {
    ...
    hud.ui.off("messages-added", this.onMessagesAdded);
    hud.ui.off("messages-updated", this.onMessagesUpdated);
    hud.ui.off("new-messages", this.onNewMessages);
  },

  // Message Logging Hooks

  onMessagesAdded: function(topic, messages) {
    messages.forEach(msg => this.onMessageAdded(msg));
  },

  onMessagesUpdated: function(topic, messages) {
    messages.forEach(msg => this.onMessageUpdated(msg));
  },

  onNewMessages: function(topic, messages) {
    messages.forEach(msg => this.onNewMessage(msg));
  },

  onMessageAdded: function(node) {
  ...
  onMessageUpdated: function(node) {
    Trace.sysout("consoleOverlay.onMessageUpdated", node);
  },

  onNewMessage: function(message) {
    Trace.sysout("consoleOverlay.onNewMessage", message);
  },
  ...
  clearConsole: function() {
    let doc = this.panelFrame.contentDocument;
