...
// Firebug
const { FBTrace, Trace, TraceError } = require("../core/trace.js").get(module.id);
...
// Fluxify
const createDispatcher = devtools["require"]("devtools/shared/create-dispatcher")();
const bindActionCreators = devtools["require"]("devtools/shared/fluxify/bindActionCreators");
...
/** @lends ConsoleOverlay */
{
  ...
  onBuild: function(options) {
    ...
    Content.exportIntoContentScope(win, Fluxify, "Fluxify");
  ...
  onApplyTheme: function(iframeWin, oldTheme) {
    ...
    loadSheet(iframeWin, self.data.url() + "console/xhr/components/xhr-spy.css", "author");
    loadSheet(iframeWin, self.data.url() + "console/xhr/components/html.css", "author");
  ...
  onUnapplyTheme: function(iframeWin, newTheme) {
    ...
    removeSheet(iframeWin, self.data.url() + "console/xhr/components/xhr-spy.css", "author");
    removeSheet(iframeWin, self.data.url() + "console/xhr/components/html.css", "author");
