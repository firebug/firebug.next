...
/** @lends ConsoleOverlay */
{
  ...
  onApplyTheme: function(iframeWin, oldTheme) {
    ...
    loadSheet(iframeWin, self.data.url() + "console/xhr/xhr-spy.css", "author");
    loadSheet(iframeWin, self.data.url() + "console/xhr/html.css", "author");
  ...
  onUnapplyTheme: function(iframeWin, newTheme) {
    ...
    removeSheet(iframeWin, self.data.url() + "console/xhr/xhr-spy.css", "author");
    removeSheet(iframeWin, self.data.url() + "console/xhr/html.css", "author");
