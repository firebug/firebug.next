...
/** @lends DebuggerOverlay */
{
  ...
  getOptionsMenuItems: function() {
    ...
    items.push({
      id: "options-pause-on-exceptions",
      type: "checkbox",
    ...
    items.push({
      id: "options-ignore-caught-exceptions",
      type: "checkbox",
    ...
    items.push({
      id: "options-show-panes-on-startup",
      type: "checkbox",
    ...
    items.push({
      id: "options-show-vars-only-enum",
      type: "checkbox",
    ...
    items.push({
      id: "options-show-vars-filter-box",
      type: "checkbox",
    ...
    items.push({
      id: "options-show-original-source",
      type: "checkbox",
