...
/** @lends DebuggerOverlay */
{
  ...
  onApplyTheme: function(iframeWin, oldTheme) {
    ...
    loadSheet(iframeWin, "chrome://firebug.next/skin/debugger.css", "author");
  ...
  onUnapplyTheme: function(iframeWin, newTheme) {
    ...
    removeSheet(iframeWin, "chrome://firebug.next/skin/debugger.css", "author");
   ...
   *
   * xxxHonza: what if the original menu ID changes? TEST ME
   */
