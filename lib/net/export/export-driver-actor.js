...
/**
 * @actor This object is responsible for exposing export API to the
 * content. This API allows to automate export of HTTP data.
 */
...
/** @lends ExportDriverActor */
{
  ...
  exposeToContent: method(expectState("attached", function() {
    Trace.sysout("ExportDriverActor.exposeToContent;", arguments);
