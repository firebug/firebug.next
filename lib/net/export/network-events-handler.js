...
function NetworkEventsHandler(netMonitor, webConsoleClient, client) {
...
/** @lends NetworkEventsHandler */
  ...
  disconnect: function() {
    ...
    all(this.promises).then(() => {
      Trace.sysout("NetworkEventsHandler.disconnect; DONE");
  ...
  onNetworkEvent: function(type, packet) {
    ...
    Trace.sysout("NetworkEventsHandler.onNetworkEvent; " + type, packet);
    ...
    if (file) {
      TraceError.sysout("NetworkEventsHandler.onNetworkEvent; ERROR " +
  ...
  onNetworkEventUpdate: function(type, packet) {
    ...
    if (!file) {
      TraceError.sysout("NetworkEventsHandler.onNetworkEventUpdate; ERROR " +
        "Unknown event actor: " + type, packet);
      return;
    }

    Trace.sysout("NetworkEventsHandler.onNetworkEventUpdate; " +
      type, packet);
  ...
  getData: function(actor, method, callback) {
    ...
    if (!this.webConsoleClient[method]) {
      TraceError.sysout("NetworkEventsHandler.getData; ERROR " +
        "Unknown method!");
      return;
    }
  ...
  onRequestHeaders: function(response) {
    Trace.sysout("NetworkEventsHandler.onRequestHeaders;", response);
  ...
  onRequestCookies: function(response) {
    Trace.sysout("NetworkEventsHandler.onRequestCookies;", response);
  ...
  onRequestPostData: function(response) {
    Trace.sysout("NetworkEventsHandler.onRequestPostData;", response);
  ...
  onResponseHeaders: function(response) {
    Trace.sysout("NetworkEventsHandler.onResponseHeaders;", response);
  ...
  onResponseCookies: function(response) {
    Trace.sysout("NetworkEventsHandler.onResponseCookies;", response);
  ...
  onResponseContent: function(response) {
    Trace.sysout("NetworkEventsHandler.onResponseContent;", response);
  ...
  onEventTimings: function(response) {
    Trace.sysout("NetworkEventsHandler.onEventTimings;", response);
