  ...
  copyToClipboard: function(panelDoc) {
    ...
    try
    {
      ...
      var doc = browser.gBrowser.mCurrentBrowser.contentDocument;
        FBTrace.sysout("!!! browser ", browser.gBrowser)
        FBTrace.sysout("!!! browser selectedBrowser ", browser.gBrowser.mCurrentBrowser)
        FBTrace.sysout("!!! browser selectedBrowser doc ", doc)
  ...
  copyImage : function(image, body, doc) {
    return function ()
    {
      ...
      try {
        ...
        browser.goDoCommand("cmd_copyImageContents");
      } catch (ex) {
