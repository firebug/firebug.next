...
/** @lends ToggleSideBarButton */
{
  ...
  initialize: function(options) {
    ...
    // Update the toggle side panel when the side panels are not loaded yet.
    // Especially because of the Inspector side panels.
    // xxxFlorent: is there a nicer way?
    this.updateButtonState = this.updateButtonState.bind(this);
    this.panel.once("side-panel-loaded", this.updateButtonState);
  },
  ...
  destroy: function() {
    ...
    this.panel.off("side-panel-loaded", this.updateButtonState);
  },
  ...
  updateButtonState: function() {
    let classList = this.button.button.classList;
    if (!this.panel.isSidebarOpened()) {
