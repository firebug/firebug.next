...
const { devtools, EventEmitter, ToolSidebar } = require("firebug.sdk/lib/core/devtools.js");
...
/** @lends BasePanel */
{
  ...
  */
  setup: function(options) {
    ...
    if (!frame) {
      TraceError.sysout("basePanel.setup; ERROR no panel frame!", options);
    }
  ...
  onSearch: function(text, reverse) {
    ...
    if (row) {
      ...
      Dom.scrollIntoCenterView(row, this.panelNode.parentNode);
