...
/** @lends Chrome */
{
  ...
  initialize: function(toolbox) {
    ...
    // xxxHonza, xxxDjalil: Firebug theme should load only
    // if it's set by default.
  ...
  onSwitchTheme: function(newTheme, oldTheme) {
    ...
    // xxxHonza, xxxDjalil: Load or unload Firebug theme (i.e. set
    // or remove the 'theme-firebug' class);
    // Utilize the Theme module.
    if (newTheme == "firebug") {
