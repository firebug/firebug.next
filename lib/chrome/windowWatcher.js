...
var browserStyleUrl = "chrome://firebug.next/skin/browser.css";
...
// Registration
main.target.on("initialize", WindowWatcher.initialize.bind(WindowWatcher));
main.target.on("shutdown", WindowWatcher.shutdown.bind(WindowWatcher));
