...
/**
 * XUL tag
 * This object allows building XUL DOM structure using predefined tags
 * (function) and simplify the code (by minimizing the amount of
 * createElement and setAttribute API calls).
 *
 * See an example:
 *
 * let box =
