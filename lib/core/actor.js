...
/**
 * This file is loaded on the back-end see 'scope' metadata field above
 * (can be a remote device) in a sandbox that doesn't have all usual
 * globals and modules (introduced by e.g. Add-on SDK).
 *
