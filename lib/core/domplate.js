...
/** @lends Renderer */
{
    ...
    insertRows: function(args, after, self)
    {
        ...
        // inside XUL documents where the element is not automatically
        // created. Note the 'doc.body' is only available in HTML docs.
        // See also issue #14 Console Service ERROR "parent is undefined"
        table.innerHTML = doc.body ? html : "<tbody>" + html + "</tbody>";
