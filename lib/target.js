...
var Target = {
  ...
  register: function(module) {
    // xxxHonza: better API, this feels hard-coded.
    this.on("initialize", module.initialize.bind(module));
    this.on("shutdown", module.shutdown.bind(module));
    this.on("toolbox-ready", module.onToolboxReady.bind(module));
    this.on("toolbox-destroy", module.onToolboxDestroy.bind(module));
  }
}
