...
const Chrome = Class({
  ...
  initialize: function(toolbox) {
    ...
    // xxxHonza: this must be generic for all panels.
    // ConsoleOverlay must be instanciated for every toolbox
    getPanelWhenReady(toolbox, "webconsole").then((panel) => {
      try
      {
        ConsoleOverlay.initialize(toolbox, panel);
      }
      catch (err)
      {
...
// Helper Methods
// xxxHonza: all the helper methods could be part of Chrome object
// to toolbox API
