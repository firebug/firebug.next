...
const { DebuggerOverlay } = require("./debuggerOverlay.js");
...
/** @lends Chrome */
  ...
  initialize: function(toolbox) {
    ...
    // List of all overlays that should be applied on existing panels
    var overlays = [
      {id: "webconsole", ctor: ConsoleOverlay},
      {id: "jsdebugger", ctor: DebuggerOverlay},
    ];

    // Iterate list of specified overlays and register a callback
    // for every panel. As soon as the callback is executed,
    // proper overlay object is created and applied.
