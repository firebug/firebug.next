...
/** @lends InspectorOverlay */
{
  ...
  onMarkupViewLoaded: function() {
    ...
    loadSheet(win, "chrome://firebug.next/skin/markup-view.css", "author");
  },
  ...
  onApplyTheme: function(iframeWin, oldTheme) {
    ...
    loadSheet(iframeWin, "chrome://firebug.next/skin/inspector.css", "author");
  ...
  onUnapplyTheme: function(iframeWin, newTheme) {
    removeSheet(iframeWin, "chrome://firebug.next/skin/inspector.css", "author");
