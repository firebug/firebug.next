...
/** @lends InspectorOverlay */
{
  ...
  onBuild: function(options) {
    ...
    this.panel.on("sidebar-created", this.onSidebarCreated);
    this.panel.on("sidebar-destroyed", this.onSidebarDestroyed);
  },
  ...
  destroy: function() {
    ...
    this.panel.off("sidebar-created", this.onSidebarCreated);
    this.panel.off("sidebar-destroyed", this.onSidebarDestroyed);
  },
  ...
  onSidebarClosed: function(eventId) {
    Trace.sysout("inspectorOverlay.onSidebarClosed;", sidebar);
  },

  onSidebarCreated: function(eventId, sidebar) {
    Trace.sysout("inspectorOverlay.onSidebarCreated;", sidebar);
  ...
  onSidebarDestroyed: function(eventId, sidebar) {
    Trace.sysout("inspectorOverlay.onSidebarDestroyed;", sidebar);
  },
  ...
  onApplyTheme: function(iframeWin, oldTheme) {
    ...
    // Create side bar toogle button.
    Win.loaded(iframeWin).then(doc => {
      let toolbar = doc.getElementById("inspector-toolbar");
      Theme.sideBarButton(this, toolbar, true);
    });
  ...
  onUnapplyTheme: function(iframeWin, newTheme) {
    ...
    Win.loaded(iframeWin).then(doc => {
      let toolbar = doc.getElementById("inspector-toolbar");
      Theme.sideBarButton(this, toolbar, false);
    });
