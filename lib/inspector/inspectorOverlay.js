...
/** @lends InspectorOverlay */
{
  ...
  // xxxHonza: this is a hack, we need proper CSS styles
  onApplyTheme: function(iframeWin, oldTheme) {
    if (iframeWin.location.href.indexOf("inspector.xul") == -1)
      return;
    ...
    // xxxHonza: this is a hack, we need proper style on top
    // of theme-light.css
