...
Hooks.prototype =
{
  onPacket: function onPacket(packet) {
    ...
    // Ignore newSource packets as well, there is too many of them
    // and it pollutes the tracing console.
    // xxxHonza: any chance to have UI with options?
    if (packet.type == "newSource") {
      return;
    }
