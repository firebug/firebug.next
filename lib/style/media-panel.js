...
const { SidePanelBase } = require("firebug.sdk/lib/side-panel-base.js");
...
/** @lends MediaPanel */
{
  ...
  setup: function(options) {
    SidePanelBase.prototype.setup.apply(this, arguments);
  ...
  destroy: function() {
    SidePanelBase.prototype.destroy.apply(this, arguments);
  ...
  onReady: function(options) {
    SidePanelBase.prototype.onReady.apply(this, arguments);
