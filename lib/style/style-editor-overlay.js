...
const { PanelToolbar, ToolbarButton } = require("../chrome/panelToolbar.js");
...
/** @lends StyleEditorOverlay */
{
  ...
  onApplyTheme: function(win, oldTheme) {
    ...
    loadSheet(win, "chrome://firebug.next/skin/style-editor.css", "author");
  ...
  onUnapplyTheme: function(win, newTheme) {
    ...
    removeSheet(win, "chrome://firebug.next/skin/style-editor.css", "author");
  ...
  unapplyFirebugLayout: function(win) {
    ...
    if (!this.mainToolbar) {
      // xxxHonza: unapplyFirebugLayout is executed twice why?
      TraceError.sysout("styleEditorOverlay.unapplyFirebugLayout; ERROR " +
        "how this can happen?");
      return;
    }
